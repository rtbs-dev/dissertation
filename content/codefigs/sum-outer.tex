...
\begin{tikzpicture}[every node/.style={anchor=north east,fill=white,minimum width=1.7cm,minimum height=7mm},ampersand replacement=\&]

\node [draw,matrixlayer] (mA) 
{
...
\node [draw,matrixlayer] (mB) at ($(mA.south west)+(2,2)$)
{
...
\node [draw,matrixlayer] (mC) at ($(mB.south west)+(2,2)$)
{
