...
In this scheme, a "data point" $\mathbf{x}_i=\left(X_{i1}, X_{i2}, \cdots X_{ik}\right)$ is a vector having some number $k$ of features that assign values to each of the relevant independent variables.
...
Thus a single observation can be thought to exist at some coordinate in $k$-dimensional space, known as the _feature space_.
