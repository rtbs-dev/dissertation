...
{{< embed A-codefigs.qmd#fig-recover  >}}
...
Network "backboning," as it has come to be called [CITE] tries to find a subset of edges in this hairball that still captures it's core topology in a way that's easier to visualize. 
