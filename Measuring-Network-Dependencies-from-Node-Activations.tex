...
\begin{tcolorbox}[enhanced jigsaw, breakable, leftrule=.75mm, colframe=quarto-callout-note-color-frame, arc=.35mm, colback=white, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm, left=2mm, opacityback=0]
...
\caption{\label{fig-fpi}FPi shows best APS, Max{[}MCC{]} and
MCC(min-connect)}
