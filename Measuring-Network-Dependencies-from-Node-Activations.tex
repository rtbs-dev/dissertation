...
\subcaption{\label{fig-incidence-mat}: Network \(G\) as an
\emph{incidence matrix} \(B\).}
...
\caption{\label{fig-incidence-graph}: Incidence matrix representation of
a graph}
...
\subcaption{\label{fig-edge-mat}: Observations embedded in ``edge
space''}
...
\caption{\label{fig-incidence-rep}: Possible edge-based embedding of
observations.}
...
\caption{\label{fig-incidence-struct}: Bipartite representation of
...
\subsection{Model vs Estimation
Approach}\label{model-vs-estimation-approach}
