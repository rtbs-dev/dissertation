...
given lists of node co-ocurrences. Networks connecting movies as being
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, colback=white, bottomrule=.15mm, breakable, arc=.35mm, opacityback=0, rightrule=.15mm, toprule=.15mm, leftrule=.75mm, left=2mm]
...
estimation of \(R\) an \(B\), in a method we call\_Expected Forest
Maximization\_(EFM). EFM shows small but consistent improvement in
...
Figure~\ref{fig-obs-cascade}. Note that nodes in some lists could be
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/content/part3/3-08-ordered_files/figure-latex/..-codefigs-graphs-fig-obs-cascade-output-1.pdf}}

}

\caption{\label{fig-obs-cascade}Observations as partially-ordered sets}
