...
\caption{\label{fig-springs}CAPTION ME}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/content/part3/3-07-ordered_files/figure-latex/..-codefigs-graphs-tbl-mwo-output-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/content/part3/3-07-ordered_files/figure-latex/..-codefigs-graphs-fig-stack-markov-output-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/content/part3/3-07-ordered_files/figure-latex/..-codefigs-qualitative-fig-fluency-workingmemory-output-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/content/part3/3-07-ordered_files/figure-latex/..-codefigs-qualitative-fig-animal-centrality-output-1.pdf}}

}

\caption{\label{fig-animal-centrality}}
...
most common animals (\emph{dog,cat,lion,tiger,bear}) have high
centrality \emph{at all}. Both GLASSO and DS have farm animals
(\emph{chicken,goat,cow}) as the most important, despite the idea that
goat likely could be reached from e.g.~\emph{cow} quite often. FP adds
more variety, giving hub-animals from different communities high
centrality scores, each of which could lead to a variety of different
paths. While subjective, the ranks from FP appear to be a more holistic
inventory of ``lynchpin'' animals, which provide nearby coverage for a
large amount of others.
