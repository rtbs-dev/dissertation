...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, breakable, leftrule=.75mm, opacityback=0, toprule=.15mm, rightrule=.15mm, bottomrule=.15mm, colback=white, arc=.35mm, colframe=quarto-callout-note-color-frame]
...
Figure~\ref{fig-fluency-dsmin} looks very similar to the network
recovered to make Fig. 4 in
\autocite{semanticorganizationanimal_Goni2011}
