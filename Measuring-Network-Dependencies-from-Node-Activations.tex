...
exactly what geometric means are for:

Then, a point estimate for the probability of an edge occurring is its
actual co-occurrence \(n_{a,b}/N\). It's the ratio of these that give us
...
\subsection{Interaction Probability}\label{sec-fpi}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/mediabag/content/part2/2-02-forest-pursuit_files/figure-latex/..-codefigs-results-fig-fpi-output-1.pdf}}
